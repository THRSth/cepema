        ...
        <div className="container">
          <div className="row containerFooterInformacao">
            <div className="col l6 s12 containerImgFooter">
              <img
                className="imgFooter"
                src={require("../../assets/img/minerva-cinza-on6wb50sxjrg3l0qqoeh6k38hblzxpi7h767z0h7m8.png")}
                alt=""
              />
            </div>
            <div className=" listasFooter">
              ...
              <div className="ulContatoFooter">
                ...
                <ul>
                  ...
                  <li>
                    <a className="grey-text text-lighten-3" href="#!">
                      <b>Telefone:</b> (13) 3362-9350
                    </a>
                  </li>
                  <li>
                    <a className="grey-text text-lighten-3" href="#!">
                      <b>Endereço:</b> Rod. Cônego Domênico Rangoni, s/n -
                      Jardim das Industrias, Cubatão - SP, 11540-990
                    </a>
                  </li>
                </ul>
              </div>
