...
const Pesquisa = () => {
    ...
    return (
        ...
        <div className="containerPesquisa">
            ...
            <div> Veja as nossas pesquisas. Por meio dessas desenvolvemos estratégias de minimização de impactos ambientais, racionalização do uso de energia, entre outras coisas.</div>
