...
const Main = () => {
    return (
        ...
        <div className="containerMenu">s
            <br/>
            <a className="negrito">Centro de Pesquisa em Meio Ambiente (CEPEMA)</a> da Universidade de São Paulo (USP). 
            ...
            <br/>
            <br/>
            <a className="negrito">Extensão universitária</a>
            No CEPEMA são desenvolvidas pesquisas de pós-graduação e extensão nas áreas ambiental, com foco em desenvolvimento de novas tecnologias e sustentabilidade.
            <br/>
            <br/>
            <a className="negrito">Infraestrutura</a>
